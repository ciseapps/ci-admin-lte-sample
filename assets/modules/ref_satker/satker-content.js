(function () {
    ...
    */
    function initialize() {
        $("#btn-create").click(function () {
            common.removeCookie("module.satker.update");
            common.direct("ref_satker/form");
        });
    }
    ...
    function initializeGrid() {
        let option = {
            title: "Satker",
            toolbar: toolbar(),
            url: common.baseURL("ref_satker/load"),
            pageNumber: 1,
            ...
            columns: [[
				...
				{field:'kode_satker', title:'KODE SATKER', halign: 'center', align: 'center', sortable:"true", width:200},
    ...
    */
    ...
    function updateRow(val) {
        common.setCookie("module.satker.update", val);
        common.direct("ref_satker/form");
    }

    function deleteRow(val) {
        common.dialogDelete(function () {
            $.post("ref_satker/delete", val, function (data, status) {
                if (200 === data.code) {
