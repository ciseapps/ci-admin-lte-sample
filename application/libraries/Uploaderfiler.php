...
class Uploaderfiler {
	...
	*/
	/*$sample 		=  base_url().'uploads/contents/sample/';
	var $user 			=  base_url().'uploads/user/';
	var $documents 		= base_url().'uploads/contents/documents/';
	var $products 		=  base_url().'uploads/contents/products/';
	var $filemanager 	=  base_url().'uploads/filemanager/';
	var $template_admin 	=  base_url().'uploads/template/admin/';
	var $template_guest 	=  base_url().'uploads/template/guest/';
	*/
	...
	//	costum config here
	public function getConfigAdmin($path) {
		return array(
			'limit' => 50, 							// Maximum Limit of files. {null, Number}
			...
			// costums on remove function, belum dinamis
		);
	}
	
	// delete upload, status : tester
